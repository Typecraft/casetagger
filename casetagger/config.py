...
Cases
"""
CASE_TYPE_POS_WORD = 1 << 1
CASE_TYPE_POS_WORD_CASE = 1 << 2
CASE_TYPE_POS_PREFIX_WORD = 1 << 3
CASE_TYPE_POS_SUFFIX_WORD = 1 << 4
CASE_TYPE_POS_PREFIX_POS = 1 << 5
CASE_TYPE_POS_SUFFIX_POS = 1 << 6
CASE_TYPE_POS_MORPHEME = 1 << 7
CASE_TYPE_POS_WORD_CONTAINS_CASE = 1 << 8

CASE_TYPE_GLOSS_MORPH = 1 << 9
CASE_TYPE_GLOSS_PREFIX_GLOSS = 1 << 10
CASE_TYPE_GLOSS_SUFFIX_GLOSS = 1 << 11
CASE_TYPE_GLOSS_PREFIX_MORPH = 1 << 12
CASE_TYPE_GLOSS_SUFFIX_MORPH = 1 << 13
CASE_TYPE_GLOSS_WORD = 1 << 14
CASE_TYPE_GLOSS_PREFIX_WORD = 1 << 15
CASE_TYPE_GLOSS_SUFFIX_WORD = 1 << 16
CASE_TYPE_GLOSS_PREFIX_POS = 1 << 17
CASE_TYPE_GLOSS_SUFFIX_POS = 1 << 18
CASE_TYPE_GLOSS_WORD_CASE = 1 << 19
CASE_TYPE_GLOSS_WORD_CONTAINS_CASE = 1 << 20
